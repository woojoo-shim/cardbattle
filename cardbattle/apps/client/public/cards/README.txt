여기에 카드 그림을 직접 넣을 수 있어요.

■ 넣는 법
- 정사각형, 배경 투명 PNG로 그림을 저장 (권장 512x512)
- 파일명을 카드 id로 지어서 이 폴더에 저장
  예) dragon.png, archangel.png, strike.png
- 저장하면 해당 카드에 자동으로 뜹니다.
- 파일을 지우면 원래 기본 그림으로 돌아갑니다.

■ 카드 id 목록
하수인(20): sprite recruit guard wolf squire archer knight cleric
...
- 그림을 꽉 채우고 싶으면 배경까지 그려서 저장해도 됩니다.
