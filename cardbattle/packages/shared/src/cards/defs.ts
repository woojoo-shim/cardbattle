...
export const CARD_DEFS: Record<string, CardDef> = {
  ...
  bind:     { id: 'bind',     name: '결박',   rarity: 'epic',   cost: 0, element: 'ice',      kind: 'special',effects: [{ kind: 'skip' }],                              cooldown: 0, vfxKey: 'bind',   sfxKey: 'bind',   icon: '⛓️', desc: '지목한 상대의 다음 턴을 건너뛰게 한다', drawWeight: 6 },
  gambit:   { id: 'gambit',   name: '도박',   rarity: 'epic',   cost: 0, element: 'none',     kind: 'special',effects: [{ kind: 'gamble' }],                            cooldown: 0, vfxKey: 'gamble', sfxKey: 'gamble', icon: '🎲', desc: '이번 턴 다음 공격이 50%로 2배, 50%로 빗나간다', drawWeight: 6 },
  sacrifice:{ id: 'sacrifice',name: '희생',   rarity: 'epic',   cost: 0, element: 'holy',     kind: 'special',effects: [{ kind: 'heal', amount: 10 }, { kind: 'empower', amount: 1.5 }, { kind: 'selfskip' }], cooldown: 0, vfxKey: 'sacrifice', sfxKey: 'sacrifice', icon: '🔥', desc: '다음 턴을 포기하는 대신 10 회복 + 이번 턴 공격 1.5배', drawWeight: 5 },
  // Extra designs — twin strike, combo recovery, finisher, and an all-out judgment.
  twinstrike:{id: 'twinstrike',name:'연격',   rarity: 'rare',   cost: 0, element: 'physical', kind: 'weapon', effects: [{ kind: 'damage', amount: 6, target: 'chosen' }, { kind: 'damage', amount: 6, target: 'chosen' }], cooldown: 0, vfxKey: 'slash', sfxKey: 'slash', icon: '⚔️', desc: '대상에게 6 피해를 두 번 (총 12)', drawWeight: 7 },
