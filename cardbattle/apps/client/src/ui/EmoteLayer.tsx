...
const bubble: React.CSSProperties = {
  ...
  background: 'linear-gradient(180deg, rgba(42,32,19,0.97), rgba(28,20,12,0.97))',
  border: `1.5px solid ${C.you}`,
  boxShadow: '0 8px 24px rgba(30,18,6,0.4), inset 0 0 16px rgba(143,157,79,0.12)',
  color: '#ece0c6', fontSize: 16, fontWeight: 800, whiteSpace: 'nowrap',
